...
$(document).ready(function () {
    ...
    $("#facebook").click(function (e) {
        $('#navbar-name').text('Facebook Stats');
        $('#content').hide();
        $('#facebook-stats').show();
        $('#instagram-stats').hide();
        $('#linkedin-stats').hide();
    ...
    $("#instagram").click(function (e) {
        $('#navbar-name').text('Instagram Stats');
        $('#content').hide();
        $('#facebook-stats').hide();
        $('#instagram-stats').show();
        $('#linkedin-stats').hide();
        $('#reddit-stats').hide();
        $('#twitter-stats').hide();
        $('#mastodon-stats').hide();
    ...
    $("#linkedin").click(function (e) {
        $('#navbar-name').text('Linkedin Stats');
        $('#content').hide();
        $('#facebook-stats').hide();
        $('#instagram-stats').hide();
        $('#linkedin-stats').show();
    ...
    $("#twitter").click(function (e) {
        $('#navbar-name').text('Twitter Stats');
        $('#content').hide();
        $('#facebook-stats').hide();
        $('#instagram-stats').hide();
        $('#linkedin-stats').hide();
    ...
    $("#mastodon").click(function (e) {
        $('#navbar-name').text('Mastodon Stats');
        $('#content').hide();
        $('#facebook-stats').hide();
        $('#instagram-stats').hide();
        $('#linkedin-stats').hide();
